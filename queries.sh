...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games ON teams.team_id IN (games.winner_id,games.opponent_id) WHERE year=2014 AND round='Eighth-Final'")"
